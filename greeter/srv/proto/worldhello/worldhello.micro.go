...
It is generated from these files:
	proto/worldhello/worldhello.proto
...
type SayService interface {
	...
	World(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *sayService) World(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Say.World", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		...
		World(ctx context.Context, in *Request, out *Response) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) World(ctx context.Context, in *Request, out *Response) error {
	return h.SayHandler.World(ctx, in, out)
}
